    ...
    <div class="max-w-3xl">
        ...
        <form method="post" action="{{ route('admin.notices.update', $notice) }}" class="space-y-4">
            ...
            <div>
                ...
                <input name="category" value="{{ old('category', $notice->category) }}" class="w-full border rounded px-3 py-2" required>
            </div>
            <div>
            ...
            <div>
                ...
                <textarea name="description" rows="6" class="w-full border rounded px-3 py-2" required>{{ old('description', $notice->description) }}</textarea>
            </div>
