...
<form method="post" action="{{ route('admin.jobs.store') }}" class="space-y-4">
    ...
    <div>
        ...
        <input name="position_type" class="w-full border rounded px-3 py-2" placeholder="faculty / non-faculty / contract" />
    </div>
    <div>
        <label class="block text-sm font-medium">Requirements</label>
        <textarea name="qualification" rows="5" class="w-full border rounded px-3 py-2"></textarea>
    </div>
    <div>
